      ...
      <div className="grid grid-cols-12 gap-3 flex-1 my-2 min-h-0 relative">
        ...
        <div className="col-span-6 flex flex-col justify-between bg-gradient-to-bl from-blue-950/40 to-slate-900 border border-blue-900/50 rounded-xl p-3 shadow-lg min-h-0 relative overflow-hidden">
          ...
          <div className="flex gap-3 flex-1 mt-3 z-10">
            ...
            >
              <span className="text-4xl sm:text-5xl mb-1 filter drop-shadow select-none leading-none">👊</span>
              <span className="text-base sm:text-lg font-black tracking-widest uppercase">PUNCH</span>
              <span className="text-[10px] font-mono font-bold tracking-wider opacity-80 mt-0.5">+1 POIN</span>
            </button>
            ...
            >
              <span className="text-4xl sm:text-5xl mb-1 filter drop-shadow select-none leading-none">🦵</span>
              <span className="text-base sm:text-lg font-black tracking-widest uppercase">KICK</span>
              <span className="text-[10px] font-mono font-bold tracking-wider opacity-80 mt-0.5">+2 POIN</span>
            </button>
          </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                ...
                >
                  <div>
                    ...
                    <div className="text-[10px] font-medium opacity-75">1 Jari ke Samping</div>
                  </div>
                ...
                >
                  <div>
                    ...
                    <div className="text-[10px] font-medium opacity-75">2 Jari ke Samping</div>
                  </div>
